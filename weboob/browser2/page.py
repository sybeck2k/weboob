...
class URL(object):
    ...
    def is_here(self, **kwargs):
        ...
        """
<<<<<<< HEAD:weboob/tools/browser2/page.py
        assert self.klass is not None, "You can use this method only if there is a BasePage class handler."
=======
        assert self.klass is not None, "You can use this method only if there is a Page class handler."
>>>>>>> a64787f7f7c5bede422b70dbdbf8aea874d4b18e:weboob/browser2/page.py
